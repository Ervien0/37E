...
using MySql.Data.MySqlClient; //Нужно установить Mysql.Data через nuget (в поиске можно найти)
...
namespace TicketApp
{
    ...
    {
        private string connString = "Server=localhost;Database=service;Uid=root;Pwd=1234;";
                    ...
                    using (var rdr = cmd.ExecuteReader())
                    {
                        while (rdr.Read())
                        {
                            list.Add(new Request
                            {
                                ...
                                RequestType = rdr.GetString("RequestType"),
